                ...
                Surface(
                    ...
                    NavHost(navController, startDestination = "home") {
                        ...
                        composable(Screen.MathHomeGame.route) {
                            MathHomeGame(navController = navController, onBackClick = { navController.navigate(Screen.Home.route) })
                        }
...
@Composable
fun MathHomeGame(navController: NavController, modifier: Modifier = Modifier, onBackClick: () -> Unit) {
    Box(
        modifier = Modifier.fillMaxSize().background(Color(0xFFF5EA7E))
    )
    Text(
        text = stringResource(R.string.gameNameee),
        fontSize = 50.sp,
        color = Color.DarkGray,
        modifier = Modifier
            .fillMaxWidth()
        ...
        content = {
            if (gameOver) {
                ...
                Column(
                    ...
                    Button(
                        onClick = { navController.navigate("mathHomeGame")},
                        modifier = Modifier.padding(bottom = 16.dp)
                    ) {
                        Text("Play Again")
                    }
